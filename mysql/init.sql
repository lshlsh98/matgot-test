...
-- =====================================================
-- 2. 기존 테이블 전체 삭제 (외래키 의존 역순)
-- =====================================================
SET FOREIGN_KEY_CHECKS = 0;

DROP TABLE IF EXISTS FAVORITE_PLAN_TBL;
DROP TABLE IF EXISTS TRAVEL_ROUTE_TBL;
DROP TABLE IF EXISTS RECOMMEND_MENU_TBL;
DROP TABLE IF EXISTS TRAVEL_SCHEDULE_TBL;
DROP TABLE IF EXISTS PLAN_TAG_TBL;
DROP TABLE IF EXISTS TRAVEL_PLAN_TBL;
DROP TABLE IF EXISTS TAG_TBL;
DROP TABLE IF EXISTS MENU_TBL;
DROP TABLE IF EXISTS BOARD_COMMENT_REPORT_TBL;
DROP TABLE IF EXISTS BOARD_REPORT_TBL;
DROP TABLE IF EXISTS BOARD_COMMENT_TBL;
DROP TABLE IF EXISTS BOARD_LIKE_TBL;
DROP TABLE IF EXISTS BOARD_TBL;
DROP TABLE IF EXISTS BOARD_PLACE_TBL;
DROP TABLE IF EXISTS review_comment_report_tbl;
DROP TABLE IF EXISTS review_comment_tbl;
DROP TABLE IF EXISTS review_report_tbl;
DROP TABLE IF EXISTS review_like_tbl;
DROP TABLE IF EXISTS review_images_tbl;
DROP TABLE IF EXISTS review_tags_tbl;
DROP TABLE IF EXISTS review_menu_tbl;
DROP TABLE IF EXISTS review_tbl;
DROP TABLE IF EXISTS rest_like_tbl;
DROP TABLE IF EXISTS rest_report_tbl;
DROP TABLE IF EXISTS restaurant_tbl;
DROP TABLE IF EXISTS SOCIAL_LOGIN_TBL;
DROP TABLE IF EXISTS LOGIN_LOG_TBL;
DROP TABLE IF EXISTS NATIVES_TBL;
...
`lat`             DOUBLE,
`lng`             DOUBLE,
`ad_content`      TINYINT UNSIGNED NULL DEFAULT 0 COMMENT '0:수신비동의/1:메일수신동의/2.문자수신동의/3:이메일문자수신동의',
...
CONSTRAINT fk_report_restaurant   FOREIGN KEY (rest_no)   REFERENCES restaurant_tbl(rest_no) ON DELETE CASCADE,
